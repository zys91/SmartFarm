...
public class ChangePwdDialog extends DialogFragment implements View.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        iv = view.findViewById(R.id.iv_change_quit);
        ...
        btn = view.findViewById(R.id.btn_change_submit);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_change_submit) {
            ...
            if (OriginPwd.getText().toString().isEmpty())
                ...
                getTargetFragment().onActivityResult(Account.REQUEST_CODE_ChangePwd, Activity.RESULT_OK, intent);
            }
        } else if (v.getId() == R.id.iv_change_quit) {
            dismiss();
        }
    }
