...
public class TBindDevice {
    private final static String TAG = "TBindDevice";

    public static Map<String, String> bindUserDevice(Context context, String uid, String token, String did) {
        ...
        try {
            ...
            Log.e(TAG, "bindUserDevice: " + er.getMessage());
        }
        return res;
    }
}
